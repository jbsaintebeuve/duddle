import { FaInstagram, FaPinterest, FaFacebook, FaLinkedin, FaTiktok } from "react-icons/fa";
import { Link } from "react-router-dom";

function Footer() {
    return (
        <footer data-scroll-section style={{ height: "80vh" }} className="bg-tequila-200 w-full relative flex flex-col items-center justify-between">
